...
export default function UserCardVertical({ data }) {
  return (
    <div className='z-0 mt-4 mx-2 lg:mx-0 w-1/6 max-w-24 lg:w-1/4 py-2 px-1 lg:p-2 2xl:p-3 flex flex-col justify-center items-center [&:nth-child(n+2)]:space-y-4 cursor-pointer'>
      <Image
