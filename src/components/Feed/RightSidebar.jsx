...
export default function RightSidebar() {
  ...
  return (
    <div className='px-6 rightSidebar sticky top-20 h-[calc(100vh-theme(spacing.20))] overflow-y-auto hidden lg:block w-1/5 text-gray-600'>
      {/* Search */}
      ...
      <div className='flex justify-between items-center'>
        {storyData.map((data) => (
          <UserCardVertical key={data.id} data={data} position='rightSidebar' />
        ))}
      </div>
